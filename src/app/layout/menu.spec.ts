...
describe('MENU', () => {
  ...
  it('marks exactly the 5 referential screens and the agencies as ready', () => {
    ...
    expect(readyRoutes.sort()).toEqual(
      ['/agencies', '/articles', '/customers', '/deliveries', '/families', '/invoices', '/packagings', '/payments', '/pricing', '/purchase-orders', '/receptions', '/stock', '/stock-movements', '/suppliers', '/units-of-measure', '/users'],
    );
  });
});
